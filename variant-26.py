...
from commands_system.employees.show_employee_with_max_salary_command import ShowEmployeeWithMaxSalaryCommand
from commands_system.employees.show_man_and_woomen_with_max_salary_command import ShowManAndWomenWithMaxSalaryCommand
...
def main() -> None:
    ...
    context.add_command(ShowEmployeeWithMaxSalaryCommand())
    context.add_command(ShowManAndWomenWithMaxSalaryCommand())
    context.start()
